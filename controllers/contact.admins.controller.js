...
const sendMessage = async (req,res,next)=>{
  ...
  try{
    ...
    if(type === "client"){
        ...
        await pool`INSERT INTO "usersMessages" (user_id,message) VALUES (${userId},${message})`;

    } else if(type === "vendor"){

        await pool`INSERT INTO "vendorsMessages" (vendor_id,message) VALUES (${userId},${message})`;
